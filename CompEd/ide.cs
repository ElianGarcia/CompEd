...
namespace CompEd
{
    public partial class Ide : Form
    {
        ...
        {
            DialogResult dialogo = MessageBox.Show("¿ Desea cerrar Compilador PHP ?", "Cerrar Compilador", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        ...
        public void abrirarchivo()
        {
            try{
                ...
                ofd.Title = "Compilador PHP                                                                   Abrir Archivo                                                                       ";
                ofd.ShowDialog();
        ...
        public void guardaArchivo()
        {
            ...
            saveFile.Filter = "Archivos php|*.php";
        ...
        public void leer_archivo_al(string nomarchivo)
        {
            ...
            catch (ArgumentNullException)
            {
                ...
                MessageBox.Show("El archivo no se pudo abrir correctamente");
